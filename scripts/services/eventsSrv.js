...
angular.module('webApp')
  .factory('eventsSrv', ['Ref','$firebaseArray','$q','$firebaseObject',function (Ref,$firebaseArray,$q,$firebaseObject) {
    ...
    var getUsers = function(n){
      return $firebaseArray(Ref.child('users').limitToFirst(n)).reverse();
    }
  ...
  var getUsersByProvince= function(province){
      return $firebaseArray(Ref.child("users").orderByChild("province").equalTo(province));    
}
    ...
    return{
      ...
      getUsersByProvince: getUsersByProvince
    }
